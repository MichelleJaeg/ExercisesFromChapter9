...
def main ():
    printIntro()
    n=getInput()
    bustnumbers=simNGames(n)
    printSummary(n, bustnumbers)
...
def printSummary(n,bustnumbers):
    print ("\nGames simulated:", n)
    for i in range(10):
        if i==0:
            print ("\nStarting value: ace")
            print ("Number of busts:", bustnumbers[i])
            print ("Probability of busting is:", bustnumbers[i]/n)
        else:
            print ("\nStarting value:", i+1)
            print ("Number of busts:", bustnumbers[i])
            print ("Probability of busting is:", bustnumbers[i]/n)
